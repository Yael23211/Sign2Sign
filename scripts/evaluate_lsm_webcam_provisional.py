# ============================================================
# Sign2Sign
# Evaluacion independiente de clases provisionales LSM
#
# Clases:
#   E, L, Z
#
# IMPORTANTE:
#   Estas clases NO pertenecen al dataset LSM genuino.
#   Fueron incorporadas provisionalmente desde ASL para
#   completar el alfabeto del reconocedor.
#
# Protocolo:
#   - E, L, Z
...
#   world_norm
#
# Se reutiliza el pipeline ya validado de:
...
OUTPUT_ROOT = Path(
    r"D:\Sign2SignData\inventory\webcam_eval\lsm_provisional"
)
...
def draw_ui(
    ...
    cv2.putText(
        frame,
        "Sign2Sign - LSM Provisional E/L/Z",
        (30, 45),
    ...
    cv2.putText(
        frame,
        "Evaluacion independiente de clases provisionales",
        (30, 80),
...
def generate_results(
    ...
    results_path = (
        run_dir
        / "provisional_webcam_results.csv"
    )
    ...
    summary = {
        ...
        "test_type":
            "provisional_classes_webcam",

        "methodological_status":
            (
                "E/L/Z are provisional classes "
                "integrated from ASL and are not "
                "part of the genuine LSM evaluation."
            ),
    ...
    for true_class in PROVISIONAL_CLASSES:
        ...
        # ====================================================
        # PROBABILIDAD MEDIA DE LA CLASE REAL
        # ====================================================
    ...
    confusion_path = (
        run_dir
        / "provisional_confusion_pairs.csv"
    )
    ...
    #
    # Columnas:
    #   26 salidas posibles del modelo.
    # ========================================================
    ...
    cm_df = pd.crosstab(
        ...
        pd.Categorical(
            ...
            categories=PROVISIONAL_CLASSES
        ),
    ...
    cm_csv_path = (
        run_dir
        / "provisional_confusion_matrix.csv"
    )
    ...
    cm_png_path = (
        run_dir
        / "provisional_confusion_matrix.png"
    )
    ...
    print(
        "=== RESULTADO LSM WEBCAM - PROVISIONALES ==="
    )
...
def main():
    ...
    print(
        "=== SIGN2SIGN - LSM PROVISIONALES E/L/Z ==="
    )
    ...
    print(
        "Las predicciones permaneceran ocultas."
    )
    ...
    print(
        "Para Z utiliza la representacion ESTATICA "
    ...
    if aborted:
        ...
        print(
            "⚠ Evaluacion provisional cancelada."
        )
        ...
        if rows:
            ...
            partial_path = (
                run_dir
                / "provisional_results_PARTIAL.csv"
            )
    ...
    print(
        "✅ Evaluacion provisional E/L/Z terminada."
    )
